...
<DocIcon name="simple-github" /> Github:  [LDLib Repository](https://github.com/Low-Drag-MC/LDLib-MultiLoader)

## Move to [LDLib2](../ldlib2/index.md)
LDLib2 is a complete rewrite of the original LDLib, redesigned from the ground up to support modern versions of Minecraft `1.21+`.