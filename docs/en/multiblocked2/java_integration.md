...
Do not reuse the old Forge event-bus setup, `create_machine` resource type, or commented Botania/GTCEu/Embers paths. The linked pages are verified against MBD2 21.1.1 on NeoForge/Minecraft 1.21.1.
:::
