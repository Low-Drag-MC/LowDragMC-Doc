...
| 采样器名称 | 描述 | 预览 |
| ---------- | ---- | ---- |
| `Sampler2` | 光照贴图 | <img src="../../assets/LightMap.png" alt="光照贴图" width="30%"> |
| `SamplerSceneColor` | 世界颜色 | <img src="../../assets/color.png" alt="世界颜色" width="30%"> |
| `SamplerSceneDepth` | 世界深度 | <img src="../../assets/Depth.webp" alt="世界深度" width="30%"> |
| `SamplerCurve` | 曲线采样器 | - |
...
<img src="../../assets/CurveAndGradient.png" alt="曲线与渐变" width="30%" class="md-img-right">
