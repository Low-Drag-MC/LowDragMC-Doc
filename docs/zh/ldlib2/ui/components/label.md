...
::: info
[TextElement](text.md) 中记录的所有内容（文本样式、自动换行、对齐方式）以及 [UIElement](element.md) 中记录的所有内容（布局、事件等）同样适用于此处。
:::
...
> 继承 [TextElement § 字段](text.md#fields) 中的所有字段。

---

## 方法

> 继承 [TextElement § 方法](text.md#methods) 中的所有方法。
