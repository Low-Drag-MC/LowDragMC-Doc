...
查看 [ModularUI 页面](./preliminary/modularui.md) 了解更多详情。
...
查看 [屏幕与菜单页面](./preliminary/screen_and_menu.md) 了解更多详情。
...
<figure>
<img src="./assets/gs_s1.png" alt="教程 1" width="80%">
</figure>
...
感谢 yoga，我们确实需要处理布局代码。查看 [布局页面](./preliminary/layout.md) 了解更多详情。
让我们通过优化布局和样式来改进 UI。
...
<figure>
<img src="./assets/gs_s3.png" alt="教程 2 结果" width="80%">
</figure>
...
<figure>
<img src="./assets/gs_s4.gif" alt="教程 3 结果" width="80%">
</figure>
...
任何 UIElement 都可以监听输入事件，如鼠标点击、悬停、命令、生命周期、拖动、焦点、键盘输入等。查看 [事件页面](./preliminary/event.md) 了解更多详情。
...
<figure>
<img src="./assets/gs_s5.gif" alt="教程 5 结果" width="80%">
</figure>
...
LSS 允许您以声明式、类似 CSS 的方式描述布局和样式属性，将视觉设计与 UI 结构分离。查看 [样式表页面](./preliminary/stylesheet.md) 了解更多详情。
...
<figure>
<img src="./assets/gs_s6.gif" alt="教程 4 结果" width="80%">
</figure>
...
查看 [数据绑定页面](./preliminary/data_bindings.md) 了解更多详情。
...
<figure>
<img src="./assets/gs_s7.gif" alt="教程 5 结果" width="80%">
</figure>
...
::: info 快速测试
要使用并打开基于菜单的 UI，您需要注册自己的 `MenuType`，LDLib2 还提供了 `ModularUIContainerScreen` 和 `ModularUIContainerMenu` 来帮助您快速设置。查看 [屏幕与菜单页面](./preliminary/screen_and_menu.md) 了解更多详情。

或者，您可以通过使用提供的 [工厂类](./factory.md) 更快地开始。
...
<figure>
<img src="./assets/gs_s8.gif" alt="教程 6 结果" width="80%">
</figure>
...
<figure>
<img src="./assets/gs_s9.gif" alt="教程 7 结果" width="80%">
</figure>
...
这还远未结束。为什么不试试强大的 [UI 编辑器](./editor.md) 呢？
